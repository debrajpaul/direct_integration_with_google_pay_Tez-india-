...
function onBuyClicked() {
    ...
    //                 .catch(function(err) {
    //                     console.log(
    //                         "Unable to calculate shipping options. " + err
    //                     );
    //                 });
    //         })
    //     );
...
function processResponse(instrument) {
    //const instrumentString = instrumentToJsonString(instrument);
    console.log("instrument tezResponse--> ", instrument.details);

    // fetch("https://tez.google.com/pay", {
    //     method: "POST",
    //     mode: "no-cors",
    //     headers: new Headers({
    //         "Content-Type": "application/json"
    //     }),
    //     body: instrument.details.tezResponse
    // })
...
//         shippingOption: instrument.shippingOption || "shipping",
//         payerName: instrument.payerName,
//         payerPhone: instrument.payerPhone,
//         payerEmail: instrument.payerEmail
//     };
//     console.log("instrumentDictionary--> ", instrumentDictionary);
...
//             1,
//             details.displayItems.length == 1 ? 0 : 1,
